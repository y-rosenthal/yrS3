...
The **repository README** is `README.md` in the project root (for GitHub). It is the **single source of truth** for the project overview. The book includes it via `docs/Overview.qmd`; **edit only the root README** so the repo and the book stay in sync.
