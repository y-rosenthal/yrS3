...
See the [DOC-GUIDE-v001.qmd](DOC-GUIDE-v001.qmd) file for a description of the naming
...
### System goals (all assets)
- **Filesystem persistence:** All main assets (questions, question sets, tags, facts, tutorial content) should be persistable on the filesystem in a human-editable form, so that editors and content creators can create and edit content either via the UI or directly in the filesystem. This is already the case for questions and question sets; the same principle applies to tags, facts, and tutorials.
- **Decentralized use (long-term):** The system should eventually support decentralized use: content creators may store content in GitHub or similar systems, and an offline or local UI may be pointed at filesystem or git repositories of content, without requiring a central server for authoring.
...
## Scope: Knowledge Domains (Initial)
...
## Question Types & Evaluation Modules
...
## Modularity & AI-Assisted Development
...
## Sandbox Isolation (Minimum Viable Level)
