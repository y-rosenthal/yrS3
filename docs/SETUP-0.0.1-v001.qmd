...
3. **Local Supabase** — If using local Supabase, run `supabase start` (and `supabase stop` when done).
4. **Database**
...
5. **Environment** — Ensure `.env.local` exists and has any new variables; compare with `.env.example` and add or update keys as needed (see @sec-environment-variables).
6. **Start the dev server** — `npm run dev`.
7. Open [http://localhost:3000](http://localhost:3000).

For full first-time setup or when you change machine or stack, see the sections below.
